...
| Value | Owner | Storage |
|---|---|---|
| Grafana OAuth client ID | CH06.1 automation | `observability/grafana-authentik-oauth` Kubernetes secret |
| Grafana OAuth client secret | CH06.1 automation | `observability/grafana-authentik-oauth` Kubernetes secret |
