...
ensure_cluster
kubectl -n "$NAMESPACE" rollout status deploy/openobserve --timeout=60s
kubectl -n "$NAMESPACE" get svc/openobserve >/dev/null
echo "PASS: OpenObserve deployment healthy"
